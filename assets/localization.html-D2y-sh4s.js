import{_ as l,r as d,o as s,c as o,a as e,b as n,w as t,e as c,d as i}from"./app-R_yqPBBy.js";const r={},u=e("h1",{id:"本地化",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#本地化"},[e("span",null,"本地化")])],-1),v={class:"table-of-contents"},m=c(`<h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介"><span>简介</span></a></h2><p>Goravel 的本地化功能提供了一种方便的方法来检索各种语言的字符串，从而使你可以轻松地在应用程序中支持多种语言。语言字符串存储在 <code>lang</code> 目录里的文件中，Goravel 支持两种方式组织语言文件：</p><p>每一种语言文件独立一个文件：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>/lang
  en.json
  cn.json
