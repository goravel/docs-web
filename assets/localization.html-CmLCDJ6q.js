import{_ as c,c as r,b as n,e as s,f as l,a as p,r as t,o,d as i}from"./app-CkrpkKpR.js";const u={},v={class:"table-of-contents"};function m(g,e){const a=t("router-link"),d=t("CommentService");return o(),r("div",null,[e[6]||(e[6]=n("h1",{id:"本地化",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#本地化"},[n("span",null,"本地化")])],-1)),n("nav",v,[n("ul",null,[n("li",null,[s(a,{to:"#简介"},{default:l(()=>e[0]||(e[0]=[i("简介")])),_:1})]),n("li",null,[s(a,{to:"#配置语言环境"},{default:l(()=>e[1]||(e[1]=[i("配置语言环境")])),_:1}),n("ul",null,[n("li",null,[s(a,{to:"#确定当前的语言环境"},{default:l(()=>e[2]||(e[2]=[i("确定当前的语言环境")])),_:1})]),n("li",null,[s(a,{to:"#定义翻译字符串"},{default:l(()=>e[3]||(e[3]=[i("定义翻译字符串")])),_:1})]),n("li",null,[s(a,{to:"#检索翻译字符串"},{default:l(()=>e[4]||(e[4]=[i("检索翻译字符串")])),_:1})])])]),n("li",null,[s(a,{to:"#embed-加载"},{default:l(()=>e[5]||(e[5]=[i("Embed 加载")])),_:1})])])]),e[7]||(e[7]=p(`<h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介"><span>简介</span></a></h2><p>Goravel 的本地化功能提供了一种方便的方法来检索各种语言的字符串，从而使你可以轻松地在应用程序中支持多种语言。语言字符串存储在 <code>lang</code> 目录里的文件中，Goravel 支持两种方式组织语言文件：</p><p>每一种语言文件独立一个文件：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">/lang</span>
...
<span class="line">  },</span>
<span class="line">})</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="embed-加载" tabindex="-1"><a class="header-anchor" href="#embed-加载"><span>Embed 加载</span></a></h2><p>使用 embed 加载时，多语言文件将会被编译到二进制文件中，部署时不再需要多语言文件。独立语言文件与 embed 加载可以同时使用，只需要在 <code>config/app.go</code> 中同时配置 <code>lang_path</code> 和 <code>lang_fs</code> 即可。使用时将优先使用独立语言文件模式，当独立语言文件不存在时，才会使用 embed 加载。</p><p>在多语言文件同级目录下创建一个 <code>fs.go</code> 文件：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">/lang</span>
<span class="line">  en.json</span>
<span class="line">  cn.json</span>
<span class="line">  fs.go</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token comment">// lang/fs.go</span></span>
<span class="line"><span class="token keyword">package</span> lang</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token string">&quot;embed&quot;</span></span>
<span class="line"></span>
<span class="line"><span class="token comment">//go:embed *</span></span>
<span class="line"><span class="token keyword">var</span> FS embed<span class="token punctuation">.</span>FS</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在 <code>config/app.go</code> 中配置：</p><div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre><code><span class="line"><span class="token comment">// config/app.go</span></span>
<span class="line"><span class="token keyword">import</span> <span class="token string">&quot;lang&quot;</span></span>
<span class="line"></span>
<span class="line"><span class="token string">&quot;lang_path&quot;</span><span class="token punctuation">:</span> <span class="token string">&quot;lang&quot;</span><span class="token punctuation">,</span></span>
<span class="line"><span class="token string">&quot;lang_fs&quot;</span><span class="token punctuation">:</span>   lang<span class="token punctuation">.</span>Fs<span class="token punctuation">,</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,42)),s(d)])}const h=c(u,[["render",m],["__file","localization.html.vue"]]),q=JSON.parse('{"path":"/zh/digging-deeper/localization.html","title":"本地化","lang":"zh-CN","frontmatter":{"description":"本地化 简介 Goravel 的本地化功能提供了一种方便的方法来检索各种语言的字符串，从而使你可以轻松地在应用程序中支持多种语言。语言字符串存储在 lang 目录里的文件中，Goravel 支持两种方式组织语言文件： 每一种语言文件独立一个文件： 或者当语言过多时，可以对其进行分类： 配置语言环境 应用程序的默认语言存储在 config/app.go ...","head":[["link",{"rel":"alternate","hreflang":"en-us","href":"https://goravel.dev/digging-deeper/localization.html"}],["meta",{"property":"og:url","content":"https://goravel.dev/zh/digging-deeper/localization.html"}],["meta",{"property":"og:site_name","content":"Goravel"}],["meta",{"property":"og:title","content":"/digging-deeper/localization.html"}],["meta",{"property":"og:description","content":"本地化 简介 Goravel 的本地化功能提供了一种方便的方法来检索各种语言的字符串，从而使你可以轻松地在应用程序中支持多种语言。语言字符串存储在 lang 目录里的文件中，Goravel 支持两种方式组织语言文件： 每一种语言文件独立一个文件： 或者当语言过多时，可以对其进行分类： 配置语言环境 应用程序的默认语言存储在 config/app.go ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:locale:alternate","content":"en-US"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"本地化\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"]]},"headers":[{"level":2,"title":"简介","slug":"简介","link":"#简介","children":[]},{"level":2,"title":"配置语言环境","slug":"配置语言环境","link":"#配置语言环境","children":[{"level":3,"title":"确定当前的语言环境","slug":"确定当前的语言环境","link":"#确定当前的语言环境","children":[]},{"level":3,"title":"定义翻译字符串","slug":"定义翻译字符串","link":"#定义翻译字符串","children":[]},{"level":3,"title":"检索翻译字符串","slug":"检索翻译字符串","link":"#检索翻译字符串","children":[]}]},{"level":2,"title":"Embed 加载","slug":"embed-加载","link":"#embed-加载","children":[]}],"git":{},"filePathRelative":"zh/digging-deeper/localization.md","autoDesc":true}');export{h as comp,q as data};
